  ...
  const handleVerifyJudge = async (judgeId, judgeName) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setRequests((prev) => prev.filter((req) => req.judgeId !== judgeId));
      } else {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2">
            Judge Mark Submission Requests
          </h1>
          <p className="text-gray-600">
            Review and verify judge mark submissions. Once verified, judges will
        ...
        {error && !requests.length ? (
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              There are currently no pending judge verification requests.
            </p>
            <button
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                When you verify a judge's submission request, their account will
