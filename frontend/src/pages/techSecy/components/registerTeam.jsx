      ...
      <div className="min-h-screen relative">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="flex flex-col items-center gap-4">
            <div className="animate-spin rounded-full h-16 w-16 border-b-4 border-[#93BBFF]"></div>
            <div className="text-xl font-semibold text-white">Loading team registration...</div>
          </div>
        </div>
      </div>
    );
        ...
        <nav className="w-full bg-[#0f1629]/80 backdrop-blur-md shadow-lg border-b border-[#93BBFF]/20 sticky top-0 z-100">
          <div className="max-w-7xl mx-auto px-6 py-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-white mb-2">{psDetails.name}</h1>
                <div className="flex items-center gap-6 text-sm text-gray-300">
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-[#93BBFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <span className="font-semibold">Team Strength:</span>
                    <span className="bg-[#93BBFF]/20 text-[#93BBFF] px-3 py-1 rounded-full font-semibold border border-[#93BBFF]/30">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="bg-green-500/20 text-green-400 px-3 py-1 rounded-full font-semibold border border-green-500/30">
                      {psDetails.points}
                    </span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 pt-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              {existingTeam && !canEdit && (
                <div className="bg-gradient-to-r from-[#93BBFF] to-[#7AABEF] text-black rounded-2xl shadow-lg p-6 mb-6 border border-[#93BBFF]/30">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    {showEditButton && (
                      <button
                        ...
                        className="bg-[#0f1629] text-white px-6 py-2 rounded-lg font-semibold hover:bg-[#1a1f3a] transition disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                      >
                        {requestingEdit
                          ? "Requesting..."
              ...
              {requestStatus === "pending" && (
                <div className="bg-yellow-500/10 border-l-4 border-yellow-400 p-4 mb-6 rounded-lg flex items-start gap-3 backdrop-blur-sm">
              ...
              {requestStatus === "rejected" && (
                <div className="bg-red-500/10 border-l-4 border-red-400 p-4 mb-6 rounded-lg flex items-start gap-3 backdrop-blur-sm">
              ...
              {error && (
                <div className="bg-red-500/10 border-l-4 border-red-500 p-4 mb-6 rounded-lg flex items-start gap-3 backdrop-blur-sm">
                  <svg className="w-5 h-5 text-red-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {message && (
                <div className="bg-green-500/10 border-l-4 border-green-500 p-4 mb-6 rounded-lg flex items-start gap-3 backdrop-blur-sm">
              ...
              {(!existingTeam || canEdit) && (
                <div className="bg-[#0f1629]/60 backdrop-blur-md rounded-2xl shadow-lg p-8 border border-[#93BBFF]/20">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-sm text-gray-300 bg-[#1a1f3a]/80 px-3 py-1 rounded-full border border-[#93BBFF]/20">
                  ...
                  <div className="space-y-6">
                    {teamMembers.map((member, index) => (
                      <div
                        key={index}
                        className="border-2 border-[#93BBFF]/30 rounded-xl p-6 bg-[#1a1f3a]/40 backdrop-blur-sm hover:border-[#93BBFF]/50 transition-all"
                      >
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="text-lg font-semibold text-white flex items-center gap-2">
                            <span className="w-8 h-8 bg-[#93BBFF]/20 text-[#93BBFF] rounded-full flex items-center justify-center font-bold text-sm border border-[#93BBFF]/30">
                              {index + 1}
                            </span>
                            Member {index + 1}
                          </h3>
                          {teamMembers.length > 1 && (
                            <button
                              ...
                              className="text-red-400 hover:text-red-300 font-medium text-sm flex items-center gap-1 hover:bg-red-500/10 px-3 py-1 rounded transition"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-2 bg-[#0f1629]/60 border border-[#93BBFF]/30 rounded-lg focus:ring-2 focus:ring-[#93BBFF] focus:border-transparent transition text-white placeholder-gray-500"
                          ...
                          <div className="md:col-span-2">
                            ...
                            {!member.profilePicture ? (
                              <label className="w-full flex items-center justify-center px-4 py-6 border-2 border-dashed border-[#93BBFF]/30 rounded-lg cursor-pointer hover:border-[#93BBFF]/50 transition bg-[#0f1629]/40">
                                <input
                                  type="file"
                                ...
                                />
                                <span className="text-sm text-gray-400">Click to upload profile picture which <span className="font-semibold text-red-400">MUST BE THE ENTIRE COLLEGE ID CARD.</span> Make sure all the details in the front side of the College ID Card are clearly visible.</span>
                              </label>
                            ) : (
                              <div className="flex flex-col items-center gap-4 p-4 border border-[#93BBFF]/30 rounded-lg bg-[#0f1629]/40">
                                {typeof member.profilePicture === "string" ? (
                                  <img
                                    ...
                                    alt="Profile"
                                    className="w-[370px] h-[250px] object-cover border border-[#93BBFF]/30"
                                  />
                                ...
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    className="cursor-pointer px-3 py-1.5 text-sm rounded-lg border border-red-400/30 text-red-400 hover:bg-red-500/10 transition"
                                  >
                                    Remove
                                  </button>
                                </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 mt-8">
                    <button
                      ...
                      className="w-full sm:flex-1 bg-[#93BBFF] text-black py-3 rounded-lg font-semibold hover:bg-[#7AABEF] transition disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-[#0f1629]/60 backdrop-blur-md rounded-2xl shadow-lg p-8 border border-[#93BBFF]/20">
                  ...
                  <div className="space-y-4">
                    {existingTeam.teamMembers.map((member, index) => (
                      <div
                        key={index}
                        className="border-2 border-[#93BBFF]/30 rounded-xl p-6 bg-[#1a1f3a]/40 backdrop-blur-sm"
                      >
                        <h3 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                          <span className="w-8 h-8 bg-green-500/20 text-green-400 rounded-full flex items-center justify-center font-bold text-sm border border-green-500/30">
                            {index + 1}
                          </span>
                          Member {index + 1}
                        </h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-300">{member.yearOfStudy}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <svg className="w-4 h-4 text-[#93BBFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="flex items-center gap-2">
                            <svg  className="size-4 text-[#93BBFF]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
                            </svg>
                            <span className="font-medium text-gray-400">Discord ID:</span>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-gray-400">Discord Username:</span>
                            <span className="text-gray-300">{member.discordUsername || "--"}</span>
                          </div>
                          ...
                          <div className="md:col-span-2 flex flex-col gap-2">
                            ...
                            (<img
                              ...
                              alt="College ID Card"
                              className="w-150 h-50 object-cover border border-[#93BBFF]/30"
                            /> ): 
                            (<div className="w-[300px] h-[100px] flex items-center justify-center border border-dashed border-[#93BBFF]/30 rounded-md bg-[#0f1629]/40 text-sm text-gray-400">
                              No ID Card uploaded
                            </div>)
                            }
                          </div>
                  ...
                  <button
                    onClick={() => navigate("/techsecy/register-team")}
                    className="w-full mt-6 bg-[#1a1f3a]/80 text-gray-300 py-3 rounded-lg font-semibold hover:bg-[#2d4a8f]/60 hover:text-white transition border border-[#93BBFF]/20"
                  >
